...
* makes <pre> and <code> tags which have Japanese text in them use a
  ...
  https://japanese.meta.stackexchange.com/questions/1162 and
  https://japanese.meta.stackexchange.com/questions/1023
* includes fixes to make ruby work with Firefox/WebKit/Blink's font adjust on mobile
  (https://chat.stackexchange.com/transcript/511?m=17474056)
...
* and makes IPA display with a font that can display IPA inside [[...]],
  //...// or [/.../] tags as at
  https://japanese.meta.stackexchange.com/questions/1287
    ...
    var ruby = {
        ...
        addToMarkdownHelp: function () {
            $('<div class="col-section">' +
                ...
                '</p>' +
                '<p>See also ' +
                '<a href="https://japanese.meta.stackexchange.com/questions/806/how-should-i-format-my-questions-on-japanese-language-se">' +
        ...
        addMenu: function () {
            ...
            var addTo = $('footer ul.-menu, footer .-copyright .jc-space-between, footer nav.links'); // .footer-links for mobile
            var upopupMenuHtml = '<a id="upopuphyperlink" style="font-weight: bold; border: 1px dashed;">Japanese&nbsp;options&nbsp;&#9660;</a><div id="upopup"></div>';

            addTo.append(upopupMenuHtml)
        ...
        addOptionsBox: function () {
            ...
            $('#upopup').append(
                '<div>' +
                '<a href="https://japanese.meta.stackexchange.com/questions/806/how-should-i-format-my-questions-on-jlu/807#807" ' +
        ...
        addEditHelp: function () {
            ...
            $('<p class="ar"><a target="_edithelp" ' +
                'href="https://japanese.meta.stackexchange.com/questions/806/how-should-i-format-my-questions-on-jlu/807#807">' +
        ...
        loop: function () {
                ...
                $('.draft-saved').each(function () {
                    ...
                    if (!this.editHelpAdded) {
                        $('<div title="Furigana Editing Help" style="float: left; padding-top: 6px; padding-right: 17px; font-weight: bold">' +
                            '<a href="https://japanese.meta.stackexchange.com/questions/806/how-should-i-format-my-questions-on-japanese-language-se" target="_blank">' +
            ...
            $('.js-post-body, .question-hyperlink, .module sidebar-related, ' +
                '.excerpt, .answer-hyperlink, .summary, .question-summary, ' +
                '.answer-summary, .question-title, .answer-title, .top-detail, ' +
                '.js-wmd-preview, #question-header, .comment-text, .comment-body, ' +
                '.single-badge-summary, .lines, .async-load, .history-table').each(function () {
                    ...
                    if (this.firstChild && !$(this).hasClass('js-wmd-preview')) {
        ...
        highlightFurigana: function (inElm, force) {
            ...
            $('ruby > span.rt,ruby > rt', inElm).each(function () {
                if (!this.resized || force) {
                    ...
                    if (contX > rtX) {
                        this.style.left = 10+ (contX / 2.0) - (rtX / 2.0) + 'px';
                    } else {
                        this.style.left = 0;
                    }
        ...
        updateUPopPos: function (upop, e, elm) {
            ...
            // This is where I edited the script :) //
        ...
        translationTags: function (inElm) {
            ...
            $('div.js-wmd-preview, div.js-post-body').each(function () {
                if (!this.firstChild) {
                    return;
